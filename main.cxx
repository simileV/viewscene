...
{
	//glm::mat4 testMat;
	//cout << "testMat = " << glm::to_string(testMat) << endl;
 ...
 //   FbxSetCallocHandler(MyMemoryAllocator::MyCalloc);
	...
	//gSceneContext = new SceneContext(NULL, DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	//gSceneContext = new SceneContext(0, DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	
	//gSceneContext = new SceneContext("zombii2.fbx", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	gSceneContext = new SceneContext("simpleSkinnedRect.fbx", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	
	//gSceneContext = new SceneContext("animatedCylinder.fbx", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);

	//gSceneContext = new SceneContext("soldier.fbx", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	//gSceneContext = new SceneContext("teapot.obj", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);
	//gSceneContext = new SceneContext("terrainTest.obj", DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT, lSupportVBO);

	cout << "lSupportVBO = " << lSupportVBO << endl;
